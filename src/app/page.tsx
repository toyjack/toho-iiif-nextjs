...
export default function Home() {
  ...
  // 获取一些示例书籍
  const featuredBooks = tohoData.books.filter(book => 
    AvailableBook.includes(book.id)
  ).slice(0, 6);
      ...
      <div className="navbar bg-base-100 shadow-sm border-b border-base-200">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow bg-base-100 rounded-box w-52">
              ...
              <li><Link href="/viewer">古籍閱覽</Link></li>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            ...
            <li><Link href="/viewer" className="font-medium">古籍閱覽</Link></li>
            <li><Link href="/about" className="font-medium">關於我們</Link></li>
          </ul>
        </div>
        <div className="navbar-end">
          <div className="form-control">
            <input type="text" placeholder="搜索古籍..." className="input input-bordered input-sm w-24 md:w-auto" />
          </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/70">按照傳統四部分類，系統整理古代典籍</p>
          </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/70">精心挑選的珍貴典籍，體驗古代文明的魅力</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredBooks.map((book) => (
              <div key={book.id} className="card bg-base-100 shadow-sm border border-base-200 hover:shadow-lg transition-all duration-300 group">
                  ...
                  <div className="card-actions justify-between items-center mt-4">
                    <div className="flex gap-1">
                      {book.bookType === 'manuscript' && (
                        <div className="badge badge-outline badge-xs">手鈔本</div>
                      )}
      ...
      <div className="py-16 px-4 bg-base-200/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base-content/70">利用現代技術，提供優質的古籍閱覽體驗</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-base-content/70">支持書名、作者、朝代等多維度搜索，快速找到目標古籍</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-base-content/70">採用IIIF標準，提供高解析度圖像和流暢的閱讀體驗</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-base-content/70">詳細的書目資訊和版本描述，支持學術研究和文獻考證</p>
            </div>
          </div>
        </div>
      </div>
